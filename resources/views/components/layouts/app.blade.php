    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="mr-5 flex items-center gap-2">
                <span class="flex aspect-square size-8 items-center justify-center rounded-md bg-zinc-800 dark:bg-zinc-200 text-white dark:text-zinc-800 font-bold text-sm">SY</span>
            ...
            <div class="flex flex-col gap-2 p-2">
                <flux:button icon="plus" variant="primary" :href="route('ventas.index', ['crear' => 1])" class="w-full">Registrar Venta</flux:button>
