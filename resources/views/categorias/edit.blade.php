...
<div class="mb-6">
    <nav class="flex items-center gap-2 mb-2 font-label-sm text-outline">
        ...
        <span class="text-on-surface">Editar Categoría</span>
    </nav>
...
$selectedIcon = old('icono', $categoria->icono ?? 'category');
@endphp
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" rows="3"
                                  class="w-full px-3 py-2 bg-white border border-outline-variant rounded-lg font-body-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none">{{ old('descripcion', $categoria->descripcion) }}</textarea>
                    </div>
                </div>
            </div>
