    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 0ms">
            <div class="flex items-start justify-between">
                <div>
                    <flux:subheading>Total Categorías</flux:subheading>
                    <flux:heading size="xl" class="mt-1">{{ $totalCategorias }}</flux:heading>
                    <flux:text size="sm" class="text-zinc-400 mt-1">Catálogo</flux:text>
                </div>
                <div class="flex items-center justify-center size-11 rounded-xl bg-blue-500/10 text-blue-600 dark:text-blue-400 shrink-0">
                    <flux:icon.tag variant="solid" class="size-6" />
                </div>
            </div>
        </flux:card>
        ...
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 80ms">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <flux:heading size="xl" class="mt-1 text-emerald-600 dark:text-emerald-400">{{ $categoriasActivas }}</flux:heading>
                    <flux:text size="sm" class="text-zinc-400 mt-1">Visibles en catálogo</flux:text>
                </div>
        ...
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 160ms">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <flux:text size="sm" class="text-zinc-400 mt-1">En todas las categorías</flux:text>
                </div>
        ...
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 240ms">
            <div class="flex items-start justify-between">
                <div>
                    <flux:subheading>Stock Crítico</flux:subheading>
                    <flux:heading size="xl" class="mt-1 text-amber-600 dark:text-amber-400">{{ $stockCritico }}</flux:heading>
