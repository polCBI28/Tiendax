<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 80ms">
            <div class="flex items-start justify-between">
                <div>
                    <flux:subheading>Ingresos Hoy</flux:subheading>
                    <flux:heading size="xl" class="mt-1 text-emerald-600 dark:text-emerald-400">S/ {{ number_format($ingresosHoy, 2) }}</flux:heading>
                </div>
        ...
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 160ms">
            <div class="flex items-start justify-between">
                <div>
                    <flux:subheading>Pendientes de Pago</flux:subheading>
                    <flux:heading size="xl" class="mt-1 text-amber-600 dark:text-amber-400">{{ $pendientes }}</flux:heading>
                </div>
                <div class="flex items-center justify-center size-11 rounded-xl bg-amber-500/10 text-amber-600 dark:text-amber-400 shrink-0">
                    <flux:icon.clock variant="solid" class="size-6" />
                </div>
            </div>
        </flux:card>
        ...
        <flux:card class="animate-fade-in-up hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300" style="animation-delay: 240ms">
            <div class="flex items-start justify-between">
                <div>
                    <flux:subheading>Ticket Promedio (mes)</flux:subheading>
    ...
    <livewire:admin.venta.venta-header />
    <livewire:admin.venta.venta-table />
    <livewire:admin.venta.venta-form />
