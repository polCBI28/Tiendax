<div>
    <flux:modal wire:model="mostrarModal" class="max-w-lg">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Importar Subcategorías</flux:heading>
                <flux:subheading>Sube un archivo Excel o CSV para crear o actualizar subcategorías por nombre.</flux:subheading>
            </div>
