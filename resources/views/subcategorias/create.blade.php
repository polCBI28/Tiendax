<x-layouts.app title="Nueva Subcategoría">
...
<div class="mb-6">
    <nav class="flex items-center gap-2 mb-2 font-label-sm text-outline">
        ...
        <span class="text-on-surface">Nueva</span>
    </nav>
    <h2 class="font-headline-lg text-headline-lg text-on-surface">Nueva Subcategoría</h2>
</div>
